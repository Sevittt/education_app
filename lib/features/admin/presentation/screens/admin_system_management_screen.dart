...
class AdminSystemManagementScreen extends StatefulWidget {
  ...
  @override
  State<AdminSystemManagementScreen> createState() =>
      _AdminSystemManagementScreenState();
}

class _AdminSystemManagementScreenState
    extends State<AdminSystemManagementScreen> {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  leading: const Icon(Icons.computer_rounded, size: 40, color: Colors.blueGrey),
                  title: Text(
                    system.name,
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  AdminAddEditSystemScreen(system: system),
                            ),
                          );
                        },
