...
class _AdminAddEditVideoScreenState extends State<AdminAddEditVideoScreen> {
  ...
  // Video categories - now as strings to match VideoEntity (includes legacy values)
  static const List<String> _categories = [
    ...
    'practical',
    'theory',
    'guide', // Legacy value from old Firestore data
  ];
  ...
  void initState() {
    ...
    _selectedCategory = _categories.contains(widget.video?.category ?? 'beginner')
        ? (widget.video?.category ?? 'beginner')
        : 'beginner';
