...
import 'package:sud_qollanma/features/courses/presentation/screens/courses_list_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  late final List<Widget> _mobileWidgetOptions;

  @override
  void initState() {
    super.initState();
    _mobileWidgetOptions = <Widget>[
  ...
  Widget _buildSpeedDial() {
    ...
    List<SpeedDialChild> getRoleBasedActions() {
      ...
      if (user.role == CourtRole.judge ||
          user.role == CourtRole.ict_specialist) {
        actions.add(
          SpeedDialChild(
  ...
  Widget build(BuildContext context) {
    ...
    Widget mobileBody = Scaffold(
      appBar: appBar,
      body: IndexedStack(index: _selectedIndex, children: _mobileWidgetOptions),
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            icon: Icon(
              _selectedIndex == 1 ? Icons.school_rounded : Icons.school_outlined,
            ),
