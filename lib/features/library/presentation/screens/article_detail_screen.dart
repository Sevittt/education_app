...
import '../../../analytics/domain/usecases/analytics_usecases.dart'; // LogXApiStatement
import 'package:sud_qollanma/features/analytics/domain/entities/xapi_statement.dart';
import 'package:sud_qollanma/features/analytics/domain/entities/xapi_actor.dart';
// import 'package:sud_qollanma/features/analytics/domain/entities/xapi_verb.dart'; // Enums usually in statement or separate
// import 'package:sud_qollanma/features/analytics/domain/entities/xapi_object.dart';
// import 'package:sud_qollanma/features/analytics/domain/entities/xapi_result.dart';
...
class _ArticleDetailScreenState extends State<ArticleDetailScreen> {
  ...
  String get _processedContent {
    ...
    return _articleContent.replaceAllMapped(urlRegExp, (match) {
      final url = match.group(0)!;
      final isPdf = url.toLowerCase().contains('.pdf');
      final title = isPdf ? '📄 Hujjatni ochish (Yuklab olish)' : '🔗 Havolani ochish';
      return '[$title]($url)';
    });
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) context.read<LibraryProvider>().incrementArticleViews(_articleId);
    });
