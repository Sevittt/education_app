...
class _ResourceDetailScreenState extends State<ResourceDetailScreen> {
  ...
  Future<void> _fetchAssociatedQuizzes() async {
    ...
    try {
      ...
      _associatedQuizzes = await context
          .read<QuizProvider>()
          .fetchQuizzesForResource(widget.resource.id);
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final CourtRole? userRole = authNotifier.appUser?.role;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (userRole == CourtRole.judge ||
              userRole == CourtRole.ict_specialist) ...[
            IconButton(
          ...
          FutureBuilder<bool>(
            future: context
                ...
                .isResourceBookmarked(widget.resource.id),
            builder: (context, snapshot) {
              ...
              return IconButton(
                ...
                tooltip: isBookmarked
                    ? l10n.bookmarkRemoveTooltip
                    : l10n.bookmarkSaveTooltip,
                onPressed: () async {
                  await context
                      .read<LibraryProvider>()
                      .toggleResourceBookmark(widget.resource.id);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  '${l10n.resourceTypeLabel}: ${widget.resource.type.name[0].toUpperCase()}${widget.resource.type.name.substring(1).toLowerCase()}', // Use widget.resource
