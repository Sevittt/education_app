...
class QuizRepositoryImpl implements QuizRepository {
  ...
  @override
  Future<List<QuizAttempt>> getRecentUserAttempts(String userId,
      {int limit = 3}) async {
  ...
  Future<void> updateQuiz(Quiz quiz) async {
    ...
    await remoteDataSource.updateQuiz(quizModel);
  }
  ...
  Future<void> deleteQuestion(String quizId, String questionId) async {
    await remoteDataSource.deleteQuestion(quizId, questionId);
  }
