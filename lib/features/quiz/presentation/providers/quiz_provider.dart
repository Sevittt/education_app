...
import '../../domain/usecases/delete_question_from_quiz.dart';
...
class QuizProvider extends ChangeNotifier {
  ...
  final UpdateQuiz updateQuizUseCase;
  final AddQuestionToQuiz addQuestionToQuizUseCase;
  final DeleteQuestionFromQuiz deleteQuestionFromQuizUseCase;
  ...
  QuizProvider({
    ...
    required this.deleteQuestionFromQuizUseCase,
  });
  ...
  Future<List<QuizAttempt>> fetchRecentUserAttempts(String userId,
      {int limit = 3}) async {
  ...
  Future<void> deleteQuestion(String quizId, String questionId) async {
    await deleteQuestionFromQuizUseCase(quizId, questionId);
  }
}
