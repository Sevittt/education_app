...
class _LoginScreenState extends State<LoginScreen> {
  ...
  /// Builds the compact language switcher shown at the top-right of the screen.
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
              ...
              child: SingleChildScrollView(
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      // Top spacing for language switcher
                      SizedBox(
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            l10n?.loginNoAccount ?? "Akkaunt yo'qmi?",
                            style: GoogleFonts.poppins(
                              color: colorScheme.onSurfaceVariant,
                            ),
                          ),
          ...
          // Language switcher — floating above everything
