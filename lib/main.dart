...
// App Check o'chirildi — Firebase Console-da Unenforced
// Localization
...
import 'package:sud_qollanma/features/community/domain/usecases/update_topic.dart';
import 'package:sud_qollanma/features/community/presentation/providers/community_provider.dart';

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:sud_qollanma/core/services/drift_database_service.dart';
import 'package:sud_qollanma/core/utils/encryption_helper.dart';
...
import 'package:sud_qollanma/features/quiz/domain/usecases/update_quiz.dart';
import 'package:sud_qollanma/features/quiz/domain/usecases/add_question_to_quiz.dart';
import 'package:sud_qollanma/features/quiz/domain/usecases/delete_question_from_quiz.dart';
...
import 'package:sud_qollanma/features/search/data/repositories/search_repository_impl.dart';
import 'package:sud_qollanma/features/search/domain/repositories/search_repository.dart';
...
// Feature: Courses
import 'package:sud_qollanma/features/courses/data/datasources/course_remote_source.dart';
import 'package:sud_qollanma/features/courses/data/repositories/course_repository_impl.dart';
import 'package:sud_qollanma/features/courses/domain/repositories/course_repository.dart';
import 'package:sud_qollanma/features/courses/presentation/providers/course_provider.dart';
import 'package:sud_qollanma/features/courses/presentation/screens/course_detail_screen.dart';
...
void main() async {
  ...
  // App Check o'chirildi — Firebase Console-da Unenforced bo'lgani kifoya

  // === OFLAYN-BIRINCHI ARXITEKTURA: Ishga tushirish ===
  // Drift (SQLite) mahalliy bazasi ishga tushiriladi
  await DriftDatabaseService.instance.init();
  // AES-256 shifrlash xizmati ishga tushiriladi (qurilma xavfsiz chipida kalit saqlanadi)
  await EncryptionHelper.instance.init();
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider<GamificationRemoteDataSource>(
            create: (_) => GamificationRemoteDataSourceImpl()),
        ...
        Provider<UpdateStreak>(
            create: (context) =>
                UpdateStreak(context.read<GamificationRepository>())),
        Provider<AwardPoints>(
            create: (context) =>
                AwardPoints(context.read<GamificationRepository>())),
        Provider<CalculateQuizScore>(
            create: (context) =>
                CalculateQuizScore(context.read<GamificationRepository>())),
        Provider<GetLeaderboard>(
            create: (context) =>
                GetLeaderboard(context.read<GamificationRepository>())),
        Provider<GetLeaderboardByRegion>(
            create: (context) =>
                GetLeaderboardByRegion(context.read<GamificationRepository>())),
        Provider<GetLeaderboardByCourtType>(
            create: (context) => GetLeaderboardByCourtType(
                context.read<GamificationRepository>())),
        Provider<GetLeaderboardByCourt>(
            create: (context) =>
                GetLeaderboardByCourt(context.read<GamificationRepository>())),
        ...
        Provider<AnalyticsRemoteDataSource>(
            create: (_) => AnalyticsRemoteDataSourceImpl()),
        Provider<AnalyticsRepository>(
            create: (context) => AnalyticsRepositoryImpl(
                context.read<AnalyticsRemoteDataSource>())),
        // Analytics UseCases (Orchestrators)
        Provider<LogXApiStatement>(
            create: (context) => LogXApiStatement(
                  context.read<AnalyticsRepository>(),
                  context.read<GamificationRepository>(),
                )),
        Provider<TrackVideoWatched>(
            create: (context) =>
                TrackVideoWatched(context.read<LogXApiStatement>())),
        Provider<TrackQuizCompleted>(
            create: (context) =>
                TrackQuizCompleted(context.read<LogXApiStatement>())),

        Provider<CommunityRemoteDataSource>(
            create: (_) => CommunityRemoteDataSourceImpl()),
        ...
        Provider<UpdateTopic>(
          create: (context) => UpdateTopic(context.read<CommunityRepository>()),
        ),
        ChangeNotifierProvider<CommunityProvider>(
          create: (context) => CommunityProvider(
            getTopics: context.read<GetTopics>(),
            createTopic: context.read<CreateTopic>(),
            updateTopicUseCase: context.read<UpdateTopic>(),
            addComment: context.read<AddComment>(),
            repository: context.read<CommunityRepository>(),
          ),
        ),

        // --- Feature: News (Clean Arch) - OFLAYN-BIRINCHI ---
        // SyncWorker: Outbox navbatini Firestore-ga idempotent yuklash uchun
        Provider<SyncWorker>(
          create: (_) => SyncWorker(
            db: DriftDatabaseService.instance.db,
            firestore: FirebaseFirestore.instance,
          )..listenToConnectivity(),
        ),
        // NewsLocalDataSource: Drift bazasi bilan ishlash
        Provider<NewsLocalDataSource>(
          create: (_) => NewsLocalDataSourceImpl(DriftDatabaseService.instance.db),
        ),
        // NewsRemoteDataSource: Firestore bilan ishlash (UUID doc ID bilan)
        Provider<NewsRemoteDataSource>(
          create: (_) => NewsRemoteDataSourceImpl(FirebaseFirestore.instance),
        ),
        Provider<NewsRepository>(
          create: (context) => NewsRepositoryImpl(
            ...
            syncWorker: context.read<SyncWorker>(),
          ),
        ),
        Provider<GetNewsStream>(
            create: (context) => GetNewsStream(context.read<NewsRepository>())),
        Provider<AddNews>(
            create: (context) => AddNews(context.read<NewsRepository>())),
        Provider<UpdateNews>(
            create: (context) => UpdateNews(context.read<NewsRepository>())),
        Provider<DeleteNews>(
            create: (context) => DeleteNews(context.read<NewsRepository>())),
        ...
        // --- Feature: Quiz (Clean Arch) ---
        Provider<QuizRemoteDataSource>(
            create: (_) => QuizRemoteDataSourceImpl()),
        ...
        Provider<GetRecentUserAttempts>(
          create: (context) =>
              GetRecentUserAttempts(context.read<QuizRepository>()),
        ),
        Provider<GetQuizzesByResourceId>(
          create: (context) =>
              GetQuizzesByResourceId(context.read<QuizRepository>()),
        ),
        Provider<DeleteQuiz>(
        ...
        Provider<UpdateQuiz>(
          create: (context) => UpdateQuiz(context.read<QuizRepository>()),
        ),
        Provider<AddQuestionToQuiz>(
          create: (context) =>
              AddQuestionToQuiz(context.read<QuizRepository>()),
        ),
        Provider<DeleteQuestionFromQuiz>(
          create: (context) =>
              DeleteQuestionFromQuiz(context.read<QuizRepository>()),
        ),
        ChangeNotifierProvider<QuizProvider>(
          create: (context) => QuizProvider(
            ...
            updateQuizUseCase: context.read<UpdateQuiz>(),
            addQuestionToQuizUseCase: context.read<AddQuestionToQuiz>(),
            deleteQuestionFromQuizUseCase:
                context.read<DeleteQuestionFromQuiz>(),
          ),
        ),
        ...
        // UseCases
        Provider<GetFaqs>(
            create: (context) => GetFaqs(context.read<FaqRepository>())),
        Provider<GetFaqsByCategory>(
            create: (context) =>
                GetFaqsByCategory(context.read<FaqRepository>())),
        Provider<GetFaqsBySystem>(
            create: (context) =>
                GetFaqsBySystem(context.read<FaqRepository>())),
        Provider<GetFaqById>(
            create: (context) => GetFaqById(context.read<FaqRepository>())),
        Provider<SearchFaqs>(
            create: (context) => SearchFaqs(context.read<FaqRepository>())),
        Provider<CreateFaq>(
            create: (context) => CreateFaq(context.read<FaqRepository>())),
        Provider<UpdateFaq>(
            create: (context) => UpdateFaq(context.read<FaqRepository>())),
        Provider<DeleteFaq>(
            create: (context) => DeleteFaq(context.read<FaqRepository>())),
        Provider<ToggleFaqHelpful>(
            create: (context) =>
                ToggleFaqHelpful(context.read<FaqRepository>())),
        // Notifier
        ...
        Provider<GetUserNotifications>(
            create: (context) =>
                GetUserNotifications(context.read<NotificationRepository>())),
        Provider<GetUnreadCount>(
            create: (context) =>
                GetUnreadCount(context.read<NotificationRepository>())),
        Provider<MarkNotificationAsRead>(
            create: (context) =>
                MarkNotificationAsRead(context.read<NotificationRepository>())),
        Provider<MarkAllNotificationsAsRead>(
            create: (context) => MarkAllNotificationsAsRead(
                context.read<NotificationRepository>())),
        Provider<CreateNotification>(
            create: (context) =>
                CreateNotification(context.read<NotificationRepository>())),
        Provider<DeleteNotification>(
            create: (context) =>
                DeleteNotification(context.read<NotificationRepository>())),
        Provider<SendBulkNotification>(
            create: (context) =>
                SendBulkNotification(context.read<NotificationRepository>())),
        Provider<CleanExpiredNotifications>(
            create: (context) => CleanExpiredNotifications(
                context.read<NotificationRepository>())),
        // Notifier
        ChangeNotifierProvider<NotificationNotifier>(
          create: (context) => NotificationNotifier(
            ...
            markAllNotificationsAsRead:
                context.read<MarkAllNotificationsAsRead>(),
            ...
            cleanExpiredNotifications:
                context.read<CleanExpiredNotifications>(),
          ),
        ),
        ...
        ChangeNotifierProvider<LibraryProvider>(
            create: (context) =>
                LibraryProvider(repository: context.read<LibraryRepository>())),
        ...
        ChangeNotifierProvider<AiNotifier>(
          create: (context) => AiNotifier(
            ...
            context.read<RagService>(),
          ),
        ),

        // Feature: Courses
        Provider<CourseRemoteSource>(create: (_) => CourseRemoteSource()),
        Provider<CourseRepository>(
          create: (context) => CourseRepositoryImpl(
            remoteSource: context.read<CourseRemoteSource>(),
        ...
        // Inject SearchAll here since it depends on CourseRepository now
        Provider<SearchAll>(
        ...
        ChangeNotifierProvider<SearchNotifier>(
          create: (context) =>
              SearchNotifier(searchAll: context.read<SearchAll>()),
        ),
...
/// FCM deep-link navigatsiyasi uchun global navigator key
