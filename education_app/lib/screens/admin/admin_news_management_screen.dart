  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<News>>(
        stream:
            newsService
                .getNewsStream(), // Get all news, or you can add limits/pagination later
                    ...
                    children: [
                      ...
                      if (newsItem.publicationDate != null)
                        Text(
                          DateFormat.yMMMd(
                            l10n.localeName,
                          ).add_jm().format(newsItem.publicationDate!.toDate()),
                          style: TextStyle(
                            fontSize: 12,
                            color: colorScheme.onSurfaceVariant,
                          ),
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed:
                            () =>
                                _deleteNewsItem(context, newsService, newsItem),
                      ),
                    ],
                  ),
                  isThreeLine: true,
