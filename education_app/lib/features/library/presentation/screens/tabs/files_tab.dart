  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<LibraryProvider>(
      builder: (context, libraryProvider, child) {
        ...
        if (libraryProvider.resources.isEmpty &&
                ...
                child: Builder(
                  builder: (context) {
                    if (libraryProvider.isLoading &&
                        libraryProvider.resources.isEmpty) {
                    ...
                    if (libraryProvider.error != null) {
                      return Center(
                          child:
                              Text(l10n.errorGeneric(libraryProvider.error!)));
                    }

                    // Filter resources
                    return FutureBuilder<List<String>>(
                      future: libraryProvider
                          .getBookmarkedResourceIds(), // Use provider method
                      builder: (context, bookmarkSnapshot) {
                        ...
                        List<ResourceEntity> filteredResources =
                          ...
                          final matchesType = _selectedResourceType == null ||
                        ...
                        if (filteredResources.isEmpty) {
                          return Center(
                              child: Text(l10n.resourcesNoResourcesFound));
                        }
