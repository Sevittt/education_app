...
import 'package:sud_qollanma/models/resource.dart';
...
class _ResourceDetailScreenState extends State<ResourceDetailScreen> {
  ...
  Future<void> _confirmDelete(
    ...
    if (confirmed == true) {
      ...
      try {
        await context.read<ResourceService>().deleteResource(
              widget.resource.id,
  ...
  Widget build(BuildContext context) {
    ...
    // ResourceService is used for the resource entity operations.
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          FutureBuilder<bool>(
            future: context
                .read<ResourceService>()
                .isBookmarked(widget.resource.id),
            builder: (context, snapshot) {
              ...
              return IconButton(
                ...
                onPressed: () async {
                  await context
                      .read<ResourceService>()
                      .toggleBookmark(widget.resource.id);
