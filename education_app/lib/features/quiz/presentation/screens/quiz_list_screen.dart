...
class _QuizListScreenState extends State<QuizListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final canManage = user?.role == UserRole.ekspert || user?.role == UserRole.admin;

    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.quizzesTitle), // Ensure this key exists or use 'Quizzes'
        actions: [
          if (canManage)
            IconButton(
      ...
      body: quizProvider.isLoading
          ...
          : quizProvider.quizzes.isEmpty
              ? Center(child: Text(l10n.noQuizzesFoundManager)) // Ensure key exists
              : ListView.builder(
