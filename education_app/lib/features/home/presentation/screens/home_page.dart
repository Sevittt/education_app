...
import 'package:sud_qollanma/features/community/presentation/screens/community_screen.dart';
import 'package:sud_qollanma/features/home/presentation/screens/home_dashboard_screen.dart';
import 'package:sud_qollanma/features/profile/presentation/screens/profile_screen.dart';

import 'package:sud_qollanma/features/library/presentation/screens/resources_screen.dart';

import 'package:sud_qollanma/features/auth/presentation/providers/auth_notifier.dart';
import 'package:sud_qollanma/models/users.dart'; // Import UserRole
import 'package:sud_qollanma/features/library/presentation/screens/create_resource_screen.dart';
import 'package:sud_qollanma/features/community/presentation/screens/create_topic_screen.dart';
import 'package:sud_qollanma/features/quiz/presentation/screens/create_quiz_screen.dart'; // Make sure this import is present
import 'package:sud_qollanma/features/notifications/presentation/providers/notification_notifier.dart';
import 'package:sud_qollanma/features/notifications/presentation/screens/notifications_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildSpeedDial() {
    ...
    if (user == null) {
      return const SizedBox
          .shrink(); // Use SizedBox.shrink() for an empty widget
    }
    ...
    return SpeedDial(
      ...
      shape: const CircleBorder(), // Pure circle shape
  ...
  Widget _buildNotificationBell() {
    ...
    return StreamBuilder<int>(
      stream: notifier.getUnreadCount(userId),
