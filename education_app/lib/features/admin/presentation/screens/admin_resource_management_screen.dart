...
class _AdminResourceManagementScreenState
  ...
  Future<void> _deleteResource(
    ...
    try {
      await context.read<ResourceService>().deleteResource(resource.id);
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // StreamBuilder handles data loading via getResources.
    });
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Resource>>(
        stream:
            Provider.of<ResourceService>(context, listen: false).getResources(),
